...
class CartTakeAwayCustomiseScreen extends StatefulWidget {
  final List customiseItems;
  final double initialText;
  final int index;
  final List listItems;

  const CartTakeAwayCustomiseScreen({
    super.key,
  ...
  _CartTakeAwayCustomiseScreenState createState() =>
      _CartTakeAwayCustomiseScreenState();
}

class _CartTakeAwayCustomiseScreenState
    extends State<CartTakeAwayCustomiseScreen> {
