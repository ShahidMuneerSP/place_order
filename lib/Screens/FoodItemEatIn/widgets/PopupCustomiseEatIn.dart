...
class PopUpCustomiseEatInScreen extends StatefulWidget {
  final List<CustomiseModel> customiseItems;

  final int index;
  final List listItem;
  const PopUpCustomiseEatInScreen({
    super.key,
    required this.index,
  ...
  @override
  State<PopUpCustomiseEatInScreen> createState() =>
      _PopUpCustomiseEatInScreenState();
}

class _PopUpCustomiseEatInScreenState extends State<PopUpCustomiseEatInScreen> {
  String _image = "";
  String _title = "";
  ...
  void initState() {
    ...
    _title = widget.listItem[widget.index].title;
    _image = widget.listItem[widget.index].image;
    _totalPrice = price + widget.listItem[widget.index].price;
